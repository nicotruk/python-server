...
from config.shared_server_config import SHARED_SERVER_FILE_UPLOAD_PATH, SHARED_SERVER_FILE_OWNERSHIP_PATH, APP_SERVER_TOKEN
        ...
        try:
            ...
            if shared_server_upload.ok:
                ...
                shared_server_file_ownership = requests.post(SHARED_SERVER_FILE_OWNERSHIP_PATH,
                                                             data=json.dumps(file_data['file']), headers=file_ownership_headers)
